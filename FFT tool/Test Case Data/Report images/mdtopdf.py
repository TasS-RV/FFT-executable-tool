...
# Path setup
md_path = Path("Test_cases_report.md").resolve()
...
HTML(string=html_content, base_url=str(base_dir)).write_pdf("Test_cases_report_wide.pdf")

print(f"✅ PDF created successfully at: {base_dir / 'Test_cases_report_wide.pdf'}")
